# Awesome Relation Extraction with stars

![awesome\_re](https://user-images.githubusercontent.com/15166794/47858006-62aa7400-de2e-11e8-82d3-165f66aaaec4.png)

A curated list of awesome resources dedicated to Relation Extraction, inspired by [awesome-nlp](https://github.com/keon/awesome-nlp) ⭐ 18,901 | 🐛 7 | 📅 2026-07-11 and [awesome-deep-vision](https://github.com/kjw0612/awesome-deep-vision) ⭐ 11,177 | 🐛 47 | 📅 2023-08-15.

**Contributing**: Please feel free to make *[pull requests](https://github.com/roomylee/awesome-relation-extraction/pulls) ⭐ 1,226 | 🐛 3 | 📅 2022-01-27*.
...
* Convolution Neural Network for Relation Extraction [\[paper\]](https://link.springer.com/chapter/10.1007/978-3-642-53917-6_21) [\[code\]](https://github.com/roomylee/cnn-relation-extraction) ⭐ 218 | 🐛 3 | 🌐 Python | 📅 2018-10-26 [\[review\]](https://github.com/roomylee/paper-review/blob/master/relation_extraction/Convolution%20Neural%20Network%20for%20Relation%20Extraction/review.md)
  * ChunYang Liu, WenBo Sun, WenHan Chao and WanXiang Che
  * ADMA 2013
* Relation Classification via Convolutional Deep Neural Network [\[paper\]](http://www.aclweb.org/anthology/C14-1220) [\[code\]](https://github.com/roomylee/cnn-relation-extraction) ⭐ 218 | 🐛 3 | 🌐 Python | 📅 2018-10-26 [\[review\]](https://github.com/roomylee/paper-review/blob/master/relation_extraction/Relation_Classification_via_Convolutional_Deep_Neural_Network/review.md)
  * Daojian Zeng, Kang Liu, Siwei Lai, Guangyou Zhou and Jun Zhao
  * COLING 2014
* Relation Extraction: Perspective from Convolutional Neural Networks [\[paper\]](http://www.cs.nyu.edu/~thien/pubs/vector15.pdf) [\[code\]](https://github.com/roomylee/cnn-relation-extraction) ⭐ 218 | 🐛 3 | 🌐 Python | 📅 2018-10-26 [\[review\]](https://github.com/roomylee/paper-review/blob/master/relation_extraction/Relation_Extraction-Perspective_from_Convolutional_Neural_Networks/review.md)
  * Thien Huu Nguyen and Ralph Grishman
  * NAACL 2015
* Relation Classification via Multi-Level Attention CNNs [\[paper\]](http://aclweb.org/anthology/P16-1123) [\[code\]](https://github.com/lawlietAi/relation-classification-via-attention-model) ⭐ 178 | 🐛 5 | 🌐 Python | 📅 2022-08-23
  * Linlin Wang, Zhu Cao, Gerard de Melo and Zhiyuan Liu
  * ACL 2016
* Classifying Relations by Ranking with Convolutional Neural Networks [\[paper\]](https://arxiv.org/abs/1504.06580) [\[code\]](https://github.com/pratapbhanu/CRCNN) ⭐ 58 | 🐛 0 | 🌐 Python | 📅 2018-07-19
  * Cicero Nogueira dos Santos, Bing Xiang and Bowen Zhou
  * ACL 2015
* Attention-Based Convolutional Neural Network for Semantic Relation Extraction [\[paper\]](http://www.aclweb.org/anthology/C16-1238) [\[code\]](https://github.com/nicolay-r/mlp-attention) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2020-09-11
...
* Attention-Based Bidirectional Long Short-Term Memory Networks for Relation Classification [\[paper\]](http://anthology.aclweb.org/P16-2034) [\[code\]](https://github.com/SeoSangwoo/Attention-Based-BiLSTM-relation-extraction) ⭐ 445 | 🐛 15 | 🌐 Python | 📅 2018-11-02
  * Peng Zhou, Wei Shi, Jun Tian, Zhenyu Qi, Bingchen Li, Hongwei Hao and Bo Xu
  * ACL 2016
* Semantic Relation Classification via Bidirectional LSTM Networks with Entity-aware Attention using Latent Entity Typing [\[paper\]](https://arxiv.org/abs/1901.08163) [\[code\]](https://github.com/roomylee/entity-aware-relation-classification) ⭐ 112 | 🐛 4 | 🌐 Python | 📅 2019-02-21
...
* Classifying Relations via Long Short Term Memory Networks along Shortest Dependency Path [\[paper\]](https://arxiv.org/abs/1508.03720) [\[code\]](https://github.com/Sshanu/Relation-Classification) ⭐ 189 | 🐛 7 | 🌐 Jupyter Notebook | 📅 2019-04-15
  * Xu Yan, Lili Mou, Ge Li, Yunchuan Chen, Hao Peng and Zhi Jin
  * EMNLP 2015
* Semantic Compositionality through Recursive Matrix-Vector Spaces [\[paper\]](http://aclweb.org/anthology/D12-1110) [\[code\]](https://github.com/pratapbhanu/MVRNN) ⭐ 11 | 🐛 2 | 🌐 Python | 📅 2015-10-09
...
* Neural Relation Extraction with Selective Attention over Instances [\[paper\]](http://www.aclweb.org/anthology/P16-1200) [\[code\]](https://github.com/thunlp/OpenNRE/) ⭐ 4,472 | 🐛 19 | 🌐 Python | 📅 2024-01-10
  * Yankai Lin, Shiqi Shen, Zhiyuan Liu, Huanbo Luan and Maosong Sun
  * ACL 2017
* RESIDE: Improving Distantly-Supervised Neural Relation Extraction using Side Information [\[paper\]](http://malllabiisc.github.io/publications/papers/reside_emnlp18.pdf) [\[code\]](https://github.com/malllabiisc/RESIDE) ⭐ 249 | 🐛 5 | 🌐 CSS | 📅 2023-03-24
...
* Distant Supervision Relation Extraction with Intra-Bag and Inter-Bag Attentions
  ...
  [\[code\]](https://github.com/ZhixiuYe/Intra-Bag-and-Inter-Bag-Attentions) ⭐ 115 | 🐛 11 | 🌐 Python | 📅 2021-07-20
  * Zhi-Xiu Ye, Zhen-Hua Ling
  * NAACL 2019
* Hierarchical Relation Extraction with Coarse-to-Fine Grained Attention[\[paper\]](https://aclweb.org/anthology/D18-1247)[\[code\]](https://github.com/thunlp/HNRE) ⭐ 93 | 🐛 2 | 🌐 Python | 📅 2020-07-30
  * Xu Han, Pengfei Yu∗, Zhiyuan Liu, Maosong Sun, Peng Li
  * EMNLP 2018
* Learning local and global contexts using a convolutional recurrent network model for relation classification in biomedical text [\[paper\]](http://www.aclweb.org/anthology/K17-1032) [\[code\]](https://github.com/desh2608/crnn-relation-classification) ⭐ 47 | 🐛 2 | 🌐 Python | 📅 2017-12-01 [\[code\]](https://github.com/kwonmha/Convolutional-Recurrent-Neural-Networks-for-Relation-Extraction) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2018-06-02
...
* SpanBERT: Improving pre-training by representing and predicting spans [\[paper\]](https://arxiv.org/abs/1907.10529.pdf) [\[code\]](https://github.com/facebookresearch/SpanBERT) ⚠️ Archived
...
* LUKE: Deep Contextualized Entity Representations with Entity-aware Self-attention
  ...
  [\[code\]](https://github.com/studio-ousia/luke) ⭐ 725 | 🐛 14 | 🌐 Jupyter Notebook | 📅 2023-11-19
...
* Improving Relation Extraction by Pretrained Language Representations
  ...
  [\[code\]](https://github.com/DFKI-NLP/TRE) ⭐ 106 | 🐛 3 | 🌐 Python | 📅 2021-10-01
...
* KGPool: Dynamic Knowledge Graph Context Selection for Relation Extraction
  ...
  [\[code\]](https://github.com/nadgeri14/KGPool) ⭐ 44 | 🐛 4 | 🌐 Python | 📅 2022-05-21
...
* FewRel: A Large-Scale Supervised Few-Shot Relation Classification Dataset with State-of-the-Art Evaluation [\[paper\]](https://arxiv.org/abs/1810.10147) [\[website\]](http://zhuhao.me/fewrel) [\[code\]](https://github.com/ProKil/FewRel) ⭐ 81 | 🐛 0 | 🌐 Python | 📅 2019-09-13
...
* **OpenNRE** [\[github\]](https://github.com/thunlp/OpenNRE) ⭐ 4,472 | 🐛 19 | 🌐 Python | 📅 2024-01-10 [\[paper\]](https://aclanthology.org/D19-3029.pdf)
...
* **AREkit** [\[github\]](https://github.com/nicolay-r/AREkit) ⭐ 66 | 🐛 6 | 🌐 Python | 📅 2026-02-05 [\[research-applicable-paper\]](https://arxiv.org/pdf/2006.13730.pdf)
  * Is an open-source and extensible toolkit focused on data preparation for document-level relation extraction organization.
    ...
    It provides
    [neural networks](https://github.com/nicolay-r/AREkit/tree/0.21.0-rc/contrib/networks) ⭐ 66 | 🐛 6 | 🌐 Python | 📅 2026-02-05 (like OpenNRE)
    and
    [BERT](https://github.com/nicolay-r/AREkit/tree/0.21.0-rc/contrib/bert) ⭐ 66 | 🐛 6 | 🌐 Python | 📅 2026-02-05 modules,
    both applicable for sentiment attitude extraction task.
* **DeRE** [\[github\]](https://github.com/ims-tcl/DeRE) ⭐ 10 | 🐛 0 | 🌐 Python | 📅 2019-01-15 [\[paper\]](https://aclanthology.org/D18-2008/)
